public class Percolation {
    ...
    private void union(int p, int q) {
        int rootP = weightedQuickUnionUF.find(p);
        int rootQ = weightedQuickUnionUF.find(q);
        ...
        if (connectToBottom) {
            int newRoot = weightedQuickUnionUF.find(p);
    ...
    public boolean isFull(int i, int j) {
        ...
        return weightedQuickUnionUF.connected(top, getArrayIndex(i, j));
    }
    ...
    public boolean percolates() {
        return isConnectedToBottom(weightedQuickUnionUF.find(top));
    }
